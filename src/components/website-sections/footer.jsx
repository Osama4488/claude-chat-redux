...
const Footer = () => {
  return (
    <footer className="bg-[#0C1025] text-white py-12 w-full">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
          {/* Column 1 */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#9465EC]">Company</h4>
            <ul className="list-none p-0 ml-0">
          ...
          {/* Column 2 */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#9465EC]">Support</h4>
            <ul className="list-none p-0 ml-0">
          ...
          {/* Column 3 */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#9465EC]">Products</h4>
            <ul className="list-none p-0 ml-0">
          ...
          {/* Column 4 */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#9465EC]">Follow Us</h4>
            <ul className="list-none p-0 ml-0">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="mb-4 text-center md:text-left">Your Company&apos;s mission statement or any other information you want to include here.</p>
